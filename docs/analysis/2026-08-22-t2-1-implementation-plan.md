...
> **日期**：2026-08-22
> **依据大纲**：
> - 方案：`docs/analysis/2026-08-18-project-optimization-plan.md` §4.11（决断 2：规则运行时输出产物 JSON，api_surface 读产物——**backend 不 import 规则侧代码**红线）
> - 实施计划：`docs/analysis/2026-08-21-explorer-track-implementation-plan.md` T2.1
