...
> **任务编号**：T2.10
> **日期**：2026-08-22
> **依据大纲**：`docs/analysis/2026-08-18-project-optimization-plan.md` §2.0/§5.4（unverified/partial → 人工队列，按置信度/引用完整度排序；partial 深挖或人工高优）、§6 风险对策（`unverified` 候选被埋没 → 人工队列排序展示）；M2 验收 §4.3.3（人工队列）
