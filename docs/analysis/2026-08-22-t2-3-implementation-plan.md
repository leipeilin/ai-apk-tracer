...
> **日期**：2026-08-22
> **依据大纲**：
> - 方案：`docs/analysis/2026-08-18-project-optimization-plan.md` §2.3（四文件 + 字段清单）+ §2.0（复用现有产物、确定性生成）
> - 实施计划：`docs/analysis/2026-08-21-explorer-track-implementation-plan.md` T2.3
> - T0.5 设计：`docs/analysis/2026-08-22-t0-5-implementation-plan.md`（schema + 决策点：receiver 合并/source 三值/空 entry_methods 不伪造）
> **状态**：起草
