...
> **任务编号**：T0.6
> **日期**：2026-08-22
> **依据实施方案**：`docs/analysis/2026-08-22-t0-6-implementation-plan.md`
> **状态**：起草
...
|---|---|---|---|
| A-1 | 映射表文档存在且完整 | `docs/analysis/2026-08-22-t0-6-normalization-mapping.md` 存在；含 10 项 required 映射 + 非 required 声明 + severity 关键词表 | 通过 |
