...
> **日期**：2026-08-22
> **依据大纲**：
> - 评审：`docs/analysis/project-optimization/2026-08-18-project-optimization-plan-review.md` §4.13（assets/batches 须走 schema_migrations）
> - 实施计划：`docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` T0.8（设计稿）、T1.1（实现）
> **状态**：起草
