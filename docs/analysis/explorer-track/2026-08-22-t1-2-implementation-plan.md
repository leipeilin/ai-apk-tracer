...
> **日期**：2026-08-22
> **依据大纲**：
> - 设计稿：`docs/analysis/explorer-track/2026-08-22-t0-8-implementation-plan.md`（assets 表结构）
> - 方案：`docs/analysis/project-optimization/2026-08-18-project-optimization-plan.md` Phase 1（资产注册）
> - 实施计划：`docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` T1.2
> **状态**：起草
