...
> **日期**：2026-08-22
> **依据大纲**：
> - 方案：`docs/analysis/project-optimization/2026-08-18-project-optimization-plan.md` §2.5（归一化映射）、§5.7（L2 链路复用）
> - 评审：`docs/analysis/project-optimization/2026-08-18-project-optimization-plan-review.md` §4.6（归一化工作量、10 项 required 验证补充）
> - 实施计划：`docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` T0.6
...
- **范围**：
  - 映射表文档 `docs/analysis/explorer-track/2026-08-22-t0-6-normalization-mapping.md`（人类可读规范，含 severity 关键词表与 `other` 处理语义）；
...
| 文件 | 变更类型 | 变更内容摘要 |
|---|---|---|
| `docs/analysis/explorer-track/2026-08-22-t0-6-normalization-mapping.md` | 新增 | 归一化映射表（T0.6 核心交付物） |
