...
> **任务编号**：T2.7
> **日期**：2026-08-22
> **依据大纲**：`docs/analysis/project-optimization/2026-08-18-project-optimization-plan.md` §2.5（探索候选校验与合流）、§2.6（Funnel 扩展）、§2.0（接入原则：related_candidate_ids 关联不合并 identity）、§4.8（S1–S11 承接）；实施计划 `docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` T2.7 行
...
| `docs/analysis/explorer-track/2026-08-22-t0-6-normalization-mapping.md` | 修改 | §3 description 行（不写，评审 R-2）与 §4 notes 分支条件收紧（评审 R-4）——契约同步（映射表 §7 纪律） |
