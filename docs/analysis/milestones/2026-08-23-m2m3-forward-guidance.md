...
- 文档：`docs/analysis/milestones/2026-08-23-m2-acceptance-runs.md` §2.2
...
- 文档：`docs/analysis/milestones/2026-08-23-m2-acceptance-runs.md` §4
...
- 任务来源：`docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` §4.4；
