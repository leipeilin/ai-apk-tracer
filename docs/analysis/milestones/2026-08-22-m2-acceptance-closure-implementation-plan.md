...
> **日期**：2026-08-22
> **依据**：`docs/analysis/milestones/2026-08-22-m2-implementation-review.md` 审查意见 4.1–4.5；`docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` §4.3 M2 专项验收（三加一口径）。
...
- **范围（in scope）**：
  ...
  4. 产出 `docs/analysis/milestones/2026-08-23-m2-acceptance-runs.md` 记录双 APK run_id、指标、结论。
  5. 更新 `docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` §4.3 checkbox 勾选状态与归属说明。
  6. 更新 `docs/analysis/milestones/2026-08-22-m2-implementation-review.md` 增加处置记录；更新 `docs/analysis/explorer-track/2026-08-22-t2-12-implementation-plan.md` 的“交接 M2 验收”行，明确由本任务执行。
...
| 覆盖：已知 8 项命中 | 依据 `docs/analysis/vulnerability-discovery/2026-08-16-vulnerability-discovery-success-plan.md` 列出的 8 项成立漏洞，在 `m2-acceptance-runs.md` 内嵌映射表（source 组件 + sink 类/方法名），由候选与最终 finding 逐项比对 |
...
- 新建 `docs/analysis/milestones/2026-08-23-m2-acceptance-runs.md`，**必须包含**：执行时 HEAD、M2 父链提交顺序、全量测试数为“提交时点快照”（当前 1147，新增后 1148）、run_id、指标、diff 结论、正/负样本映射表、未达标项说明。
- 修改 `docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md` §4.3：按实测勾选 checkbox，并在 §4.3 末尾写明“执行记录见 m2-acceptance-runs.md；未达标项单独列明”；
- 修改 `docs/analysis/milestones/2026-08-22-m2-implementation-review.md`：增加“处置记录”区，逐条标注 4.1–4.5 的处置结果；
- 修改 `docs/analysis/explorer-track/2026-08-22-t2-12-implementation-plan.md` §4 末行：将“交接 M2 验收”改为“已由 M2-ACCEPTANCE-CLOSURE 执行，记录见 m2-acceptance-runs.md”。
...
- `docs/analysis/milestones/2026-08-23-m2-acceptance-runs.md`
- 更新：`docs/analysis/explorer-track/2026-08-21-explorer-track-implementation-plan.md`
- 更新：`docs/analysis/milestones/2026-08-22-m2-implementation-review.md`
- 更新：`docs/analysis/explorer-track/2026-08-22-t2-12-implementation-plan.md`
