...
> **日期**：2026-08-22
> **依据大纲**：
> - 方案：`docs/analysis/2026-08-18-project-optimization-plan.md` Phase 1（批量扫描、batch 预算帽）+ §4.12/§4.9 语义
> - 实施计划：`docs/analysis/2026-08-21-explorer-track-implementation-plan.md` T1.3（串行/并发、失败重试、预算帽与降级、`ai_skipped_by_batch_budget` 标记）
