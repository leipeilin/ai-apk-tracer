...
> **日期**：2026-08-21
> **依据大纲**：
> - 方案：`docs/analysis/2026-08-18-project-optimization-plan.md` §5.3（探索候选 Schema 草案）、§2.5（归一化映射）
> - 实施计划：`docs/analysis/2026-08-21-explorer-track-implementation-plan.md` T0.2
> **状态**：起草
